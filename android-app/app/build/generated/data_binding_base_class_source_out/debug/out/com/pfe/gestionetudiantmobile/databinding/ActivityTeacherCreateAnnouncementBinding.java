...
public final class ActivityTeacherCreateAnnouncementBinding implements ViewBinding {
  @NonNull
  ...
  @NonNull
  public static ActivityTeacherCreateAnnouncementBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityTeacherCreateAnnouncementBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_teacher_create_announcement, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityTeacherCreateAnnouncementBinding bind(@NonNull View rootView) {
